...
/*   Updated: 2024/07/20 18:44:29 by descamil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char *ft_change_var(char *div, char **env)
{
	...
	if (div && ((ft_strlen(div) == 1 && ft_strncmp(div, "$", 1) == 0) || (ft_strlen(div) == 2 && ft_strncmp(div, "$$", 2) == 0)))
	{
		str = ft_calloc(sizeof(char), ft_strlen(div) + 1);
		if (str == NULL)
			return (NULL);
		ft_memset(str, '$', ft_strlen(div));
		return (str);
	}
...
char	*ft_dolar_to_iqual(char *div)
{
	...
	if (ft_strncmp(div, "$", 1) == 0 && ft_strlen(div) == 1)
		return (div);
	if (ft_strncmp(div, "$$", 2) == 0 && ft_strlen(div) == 2)
		return (div);
	while (div[j] != '\0')
		div[i++] = div[j++];
	if (div[j] == '\0')
