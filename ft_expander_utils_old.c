...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_expander_utils_old.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: descamil <descamil@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/02 18:04:30 by smarin-a          #+#    #+#             */
/*   Updated: 2024/06/09 14:03:39 by descamil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

char	*ft_strjoin_custom_old(char *str1, char *str2, size_t i, size_t c)
{
	char	*str;
	size_t	size1;
...
int	ft_var_strcmp_old(char *str1, char *str2)
{
	size_t	i;
...
char	*ft_add_var_value_old(char *str1)
{
	int		i;
	int		j;
	char	*result;
...
char	*ft_change_line_value_old(char *line, char *var)
{
	int		i;
	int		j;
	char	*final_line;
...
char	*ft_compare_var_name_old(t_cmd *cmd, char *line, char *name_var)
{
	int		i;
	char	*result;
