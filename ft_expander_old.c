...
char	*ft_craft_result_old(char *final_line, char *line, char *var, int c)
{
	int	i;
	int	j;
	int	k;
...
int	ft_locate_dollar_old(char *cmd)
{
	int	i;
	int	double_quote;
...
char	*ft_change_name_var_old(char *line)
{
	int		i;
	int		j;
	char	*var_name;
...
char	*ft_change_var_old(t_cmd *cmd, char *line, char **var_reminder)
{
	char	*var_name;
	int		i;
...
char	*ft_change_dollar_x_var_old(t_cmd *cmd, char *command, char *var_reminder)
{
	char	*temp;
